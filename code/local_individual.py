"""
Explore the impact of individual agent on evacuation times, both with and without obstacles.
Vary the ratio of single agent while keeping the total number of agents constant.
...
plt.legend()
plt.savefig('indiviudal_ratio_15.png', dpi=150)
