...
class GUI:
    ...
    def add_barrier(self):
        #  添加房间边框
        self.c.create_rectangle(0, 0, 1080, 40, fill="#696969", outline="#696969")  # 是在tkinter中绘制矩形的方法 
        ...
        #  添加房间中间的障碍物
        #self.c.create_rectangle(540, 240, 540 + 40, 240 + 200, fill="#696969", outline="#696969")
